            ...
            <div class="container">
                ...
                <form method="post" action="process_upload.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea class="form-control" id="videoDescription" name="videoDescription" rows="4" required></textarea>
                    </div>
                    <div class="form-group my-3">
                    ...
                    <div class="form-check my-3">
                        <input type="checkbox" class="form-check-input" id="privacyCheckbox" name="privacyCheckbox">
